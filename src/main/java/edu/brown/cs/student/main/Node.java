...
public abstract class Node implements INode {
  /**
   * fields for Node
   * - coordinates: a List of any object, the elements are the coordinates 
   *                for example, int weight, int height, int age would all be
   *                an element of the list in that order 
   ...
   *
   */
  public Node(Node p, Node lc, Node rc) {
    this.parent = p;
    this.leftChild = lc;
    this.rightChild = rc;
  }
